...
import de.tudarmstadt.ukp.dkpro.core.jazzy.CorrectionsContextualizer;
...
//		AnalysisEngineDescription jazzyChecker  = getJazzyChecker(language.code);
...
//		components.add(jazzyChecker);
	...
	private AnalysisEngineDescription getJazzyChecker(String languageCode) 
			throws ResourceInitializationException
	{		
		return null;
	}
