			...
			while ((nextLine = reader.readLine()) != null) {
				...
				if (nextItem.length == 28) {
					//System.out.println(nextItem[0]+"\t"+nextItem[1]+"\t"+nextItem[2]);
					  ...
					  essayId = Integer.parseInt(nextItem[0].trim()); essaySetId =
					  Integer.parseInt(nextItem[1].trim()); score =
					  Integer.parseInt(nextItem[6].trim());
