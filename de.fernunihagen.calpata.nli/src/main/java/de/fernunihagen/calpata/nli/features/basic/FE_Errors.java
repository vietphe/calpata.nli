...
public class FE_Errors 
	extends FeatureExtractor_ImplBase
{
	boolean nominalized = true;
	...
	public static final String typo = "^Possible typo.*";
...
//		int numberOfWord = tokens.size()-punct;
		...
		double nrOfSpellingMistake = 0;
		double nrOfPunctuation = 0;
		double nrOfTypo = 0;
		double nrOfCollocation = 0;
		double nrOfGrammarArticle = 0;
		double nrOfGrammarPreposition = 0;
		double nrOfGrammarVerb = 0;
		double nrOfOtherGrammaticalError = 0;
...
//				s.setName("no error");
//				s.addToIndexes();
			}else if (spellingMistakeM1.find()||spellingMistakeM2.find()){
				...
				nrOfSpellingMistake++;
					...
					||puncM16.find()||puncM17.find()||puncM18.find()||puncM19.find()||puncM20.find()||puncM21.find()||puncM22.find()
					||puncM23.find()||puncM24.find()||puncM25.find()||puncM26.find()) {
				...
				if(grammarArticleM.find()) {
					nrOfGrammarArticle++;
				}else if (grammarPrepositionM.find()) {
					nrOfGrammarPreposition++;
					...
					nrOfOtherGrammaticalError++;
				}
				
			}				
		}
//		System.out.println("sm: "+ nrOfSpellingMistake/2);
//		System.out.println("typo: "+ nrOfTypo/2);
//		System.out.println("punc: "+ nrOfPunctuation/2);
//		System.out.println("collo: "+ nrOfCollocation/2);
//		System.out.println("art: "+ nrOfGrammarArticle/2);
//		System.out.println("verb: "+ nrOfGrammarVerb/2);
//		System.out.println("prepo: "+ nrOfGrammarPreposition/2);
//		System.out.println("other: "+ nrOfOtherGrammaticalError/2);
		
//		System.out.println("size: "+ tokens.size());
		
		Set<Feature> features = new HashSet<>();
		if(nominalized) {
			features.add(new Feature("NrOfSpellingMistakesPerNrOfTokens", (nrOfSpellingMistake/2)/tokens.size(), FeatureType.NUMERIC)); //divided by 2 because each "error message" of Languagetool is repeated twice
			//TRACE
//			features.add(new Feature("NrOfSpellingMistakesPerNrOfTokens", (nrOfSpellingMistake/2)*100/numberOfWord, FeatureType.NUMERIC));
			
			features.add(new Feature("NrOfTyposPerNrOfTokens", (nrOfTypo/2)/tokens.size(), FeatureType.NUMERIC));
			features.add(new Feature("NrOfPunctuationErrorsPerNrOfTokens", (nrOfPunctuation/2)/tokens.size(), FeatureType.NUMERIC));
			features.add(new Feature("NrOfCollocationErrorsPerNrOfTokens", (nrOfCollocation/2)/tokens.size(), FeatureType.NUMERIC));
			features.add(new Feature("NrOfArticleErrorsPerNrOfTokens", (nrOfGrammarArticle/2)/tokens.size(), FeatureType.NUMERIC));
			features.add(new Feature("NrOfPrepositionErrorsPerNrOfTokens", (nrOfGrammarPreposition/2)/tokens.size(), FeatureType.NUMERIC));
			features.add(new Feature("NrOfVerbErrorsPerNrOfTokens", (nrOfGrammarVerb/2)/tokens.size(), FeatureType.NUMERIC));
			features.add(new Feature("NrOfOtherGrammaticalErrorsPerNrOfTokens", (nrOfOtherGrammaticalError/2)/tokens.size(), FeatureType.NUMERIC));
			return features;
		}else {
			features.add(new Feature("NrOfSpellingMistakes", nrOfSpellingMistake/2, FeatureType.NUMERIC));
			features.add(new Feature("NrOfTypos", nrOfTypo/2, FeatureType.NUMERIC));
			features.add(new Feature("NrOfPunctuationErrors", nrOfPunctuation/2, FeatureType.NUMERIC));
			features.add(new Feature("NrOfCollocationErrors", nrOfCollocation/2, FeatureType.NUMERIC));
			features.add(new Feature("NrOfArticleErrors", nrOfGrammarArticle/2, FeatureType.NUMERIC));
			features.add(new Feature("NrOfPrepositionErrors", nrOfGrammarPreposition/2, FeatureType.NUMERIC));
			features.add(new Feature("NrOfVerbErrors", nrOfGrammarVerb/2, FeatureType.NUMERIC));
			features.add(new Feature("NrOfOtherGrammaticalErrors", nrOfOtherGrammaticalError/2, FeatureType.NUMERIC));
			return features;
		}
